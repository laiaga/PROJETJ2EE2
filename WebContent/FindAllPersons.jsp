...
<form action="/PROJETJ2EE2/GestionAnnuaireServlet?ACTION=FIND_ALL_PERSONS" method="GET">
	<input type=hidden id="ACTION" name="ACTION" value="FIND_ALL_PERSONS"/>
	<select id="GroupNameSelect" name="GroupNameSelect" onchange="this.form.submit()">
